        ...
        <section className="slw-sec" id="sec1">
            ...
            <div className="listing-slider-wrap fl-wrap">
                <div className="listing-slider fl-wrap">
                                    ...
                                    <div className="listing-item listing_carditem">
                                        <article className="geodir-category-listing fl-wrap">
                                            <div className="geodir-category-img">
                                                ...
                                                <div className="geodir_status_date gsd_close"><i
                                                    className="fal fa-lock"/>Close Now
                                                </div>
                                                <div className="geodir-category-opt">
                                                    <div className="geodir-category-opt_title">
                                                        ...
                                                        <div className="geodir-category-location"><a href="#"><i
                                                            className="fas fa-map-marker-alt"/> 70 Bright St New York,
                                                            USA</a></div>
                                                    </div>
                                                    ...
                                                    <div className="listing_carditem_footer fl-wrap">
                                                        <a className="listing-item-category-wrap" href="#">
                                                            <div className="listing-item-category blue-bg"><i
                                                                className="fal fa-dumbbell"/></div>
                                                        ...
                                                        <div className="post-author"><a href="#"><img
                                                            ...
                                                            alt/><span>By , Mark Rose</span></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </article>
                                        ...
                                        <article className="geodir-category-listing fl-wrap">
                                            <div className="geodir-category-img">
                                                ...
                                                <div className="geodir-category-opt">
                                                    ...
                                                    <div className="listing_carditem_footer fl-wrap">
                                                        <a className="listing-item-category-wrap" href="#">
                                                            <div className="listing-item-category  yellow-bg"><i
                                                                className="fal fa-bed"/></div>
                                                            <span>Hotels</span>
                                                        </a>
                                                        <div className="price-level geodir-category_price">
                                                        ...
                                                        <div className="post-author"><a href="#"><img
                                                            src="images/avatar/5.jpg" alt/><span>By , Nasty Wood</span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="geodir-category-img">
                                                ...
                                                <div className="geodir-category-opt">
                                                    <div className="geodir-category-opt_title">
                                                        ...
                                                        <div className="geodir-category-location"><a href="#"><i
                                                            className="fas fa-map-marker-alt"/> 40 Journal Square Plaza,
                                                            NJ, USA</a></div>
                                                    </div>
                                                    <div className="listing-rating-count-wrap">
                                                        <div className="review-score">5.0</div>
                                                    ...
                                                    <div className="listing_carditem_footer fl-wrap">
                                                        <a className="listing-item-category-wrap" href="#">
                                                            <div className="listing-item-category green-bg"><i
                                                                className="fal fa-cart-arrow-down"/></div>
                                                            <span>Shopping</span>
                                                        </a>
                                                        <div className="price-level geodir-category_price">
                                                            <span className="price-level-item" data-pricerating={4}/>
                                                        ...
                                                        <div className="post-author"><a href="#"><img
                                                            ...
                                                            alt/><span>By , Kliff Antony</span></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </article>
                    ...
                    <div className="listing-carousel-button listing-carousel-button-next2"><i
                        className="fas fa-caret-right"/></div>
                    <div className="listing-carousel-button listing-carousel-button-prev2"><i
                        className="fas fa-caret-left"/></div>
                </div>
...
export default EventCardFullSection
