const Home = () => {
    return (
        ...
        <span className="new-dashboard-item">
          <i className="fal fa-times"/>
        </span>
                        <div className="dashboard-message-text">
                            <i className="far fa-check green-bg"/>
                            <p>
                                Your listing <a href="#">Park Central</a> has been approved!{" "}
                            </p>
                        </div>
                        <div className="dashboard-message-time">
                            <i className="fal fa-calendar-week"/> 28 may 2020
                        </div>
                    </div>
                </div>
                {/* dashboard-list end*/}
        ...
        <span className="new-dashboard-item">
          <i className="fal fa-times"/>
                        ...
                        <div className="dashboard-message-text">
                            ...
                            <p>
                                Someone bookmarked your <a href="#">Holiday Home</a> listing!
                            </p>
                        </div>
                        <div className="dashboard-message-time">
                            <i className="fal fa-calendar-week"/> 28 may 2020
        ...
        <span className="new-dashboard-item">
          <i className="fal fa-times"/>
                        ...
                        <div className="dashboard-message-text">
                            ...
                            <p>
                                {" "}
                                Your listing <a href="#">Holiday Home</a> has been approved!{" "}
                            </p>
                        </div>
                        <div className="dashboard-message-time">
                            <i className="fal fa-calendar-week"/> 28 may 2020
        ...
        <span className="new-dashboard-item">
          <i className="fal fa-times"/>
                        ...
                        <div className="dashboard-message-text">
                            <i className="far fa-heart purp-bg"/>
                            <p>
                                Someone bookmarked your <a href="#">Moonlight Hotel</a> listing!
                            </p>
                        </div>
                        <div className="dashboard-message-time">
                            <i className="fal fa-calendar-week"/> 28 may 2020
