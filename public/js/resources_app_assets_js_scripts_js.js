(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_app_assets_js_scripts_js"],{

/***/ "./resources/app/assets/js/scripts.js":
/*!********************************************!*\
  !*** ./resources/app/assets/js/scripts.js ***!
  \********************************************/
/***/ (() => {
...
function initTowhub() {
  ...
  if ($(window).width() > 1024) {
    if ($(".video-holder").size() > 0) if (bvmc.height() / 9 * 16 > bvmc.width()) {
  ...
  } else $(".fixed-bar").removeClass("fixbar-action"); // filter show -----------------
  ...
  shf.on("click", function () {
    if ($(this).hasClass("shsb_btn_act")) showhiddenfilters();else hidehiddenfilters();
  });
  ...
  $('.chosen-select').niceSelect(); // rangeslider -----------------
